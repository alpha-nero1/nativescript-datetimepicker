...
var DateTimePicker = (function (_super) {
    ...
    DateTimePicker.SUPPORT_DATE_PICKER_STYLE = parseFloat(platform_1.device.osVersion) >= 14.0;
    DateTimePicker.SUPPORT_TEXT_COLOR = parseFloat(platform_1.device.osVersion) < 14.0;
    DateTimePicker.DEFAULT_DATE_PICKER_STYLE = 1;
